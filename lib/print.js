...
export default async function (m, conn = { user: {} }) {
  ...
  console.log(`
${(chalk.cyan('╭────═[💚 BLUE ARCHIVE 💚]═─────'))}
${(chalk.cyan('│╭───────────────···'))}
${(chalk.cyan('┴│💚 '))} ${chalk.blue('%s')}
${(chalk.cyan('B│💚 '))} ${chalk.black(chalk.cyan('%s'))}ㅤ${chalk.black(chalk.cyan('%s'))} 
${(chalk.cyan('V│💚 '))} ${chalk.magenta('%s [%s %sB]')}
${(chalk.cyan('H│💚 '))} ${chalk.white('%s')}
${(chalk.cyan('3│💚 '))} ${chalk.yellow('%s%s')}
